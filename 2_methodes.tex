...
Au début du sprint, l'équipe se rassemble pour une \textit{réunion de planification de sprint}, pendant laquelle l'équipe cherche à prévoir ce qui sera développé durant le prochain sprint et sur la manière dont ses membres atteindront cet objectif.
...
Une \gls{ESN} doit s'adapter aux clients. Si celui-ci n'impose aucune méthode ou norme à appliquer, elles sont décidées par GFI au cas par cas et dans ce cas ne comportent pas de Service Qualité.
