...
\fig{img/avant_vcs.png}{avant_vcs}{Représentation graphique des difficultés du développement logiciel.}
...
\fig{img/apres_vcs.png}{apres_vcs}{Représentation graphique des solutions qu'apportent les logiciels de gestion de version.}
